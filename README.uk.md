...
Профіль поки має статус **unverified**: версію та SHA-256 офіційного інсталятора зафіксовано, але API-відповіді й часові правила ще не порівняно з реальним терміналом. Це видно в CLI, API, UI та звіті покриття. Емулятор не звертається до банку й не проводить справжніх платежів.
